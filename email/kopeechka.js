...
export default class {
    ...
    async getEmail() {
        const { json: { id, mail, status, value } } = await this.session.get(`http://api.kopeechka.store/mailbox-get-email?site=discord.com&mail_type=REAL&token=${this.key}&type=JSON&api=2.0`);
